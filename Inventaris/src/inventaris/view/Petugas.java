...
public class Petugas extends javax.swing.JPanel {
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(btnMasukTambah, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(btnMasukHapus, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnMasukHapus, btnMasukSimpan});
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(62, 62, 62)
                                .addComponent(cbIdGudangCari, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        ...
        jLabel13.setText("View All Barang");
    ...
    public JButton getBtnKelolaCari(){
        return btnKelolaCari;
    }
    
    public JButton getBtnKelolaEdit(){
        return btnKelolaEdit;
    }
    
    public JButton getBtnKelolaHapus(){
        return btnKelolaHapus;
    }
    
    public JButton getBtnKelolaSimpan(){
    ...
    public void setListView(ArrayList<Gudang> list, int length){
        String[] judul = {"ID Barang","Nama Barang","Jumlah","Barang Baik","Barang Tidak Baik","ID Gudang"};
        String[][] isi = new String[length][6];
        int i = 0;
        for (Gudang g : list){
            for (Barang b : g.getListBarang()){
                isi[i][0] = String.valueOf(b.getID());
                isi[i][1] = b.getNama();
                isi[i][2] = String.valueOf(b.getJumlah());
                isi[i][3] = String.valueOf(b.getKondisiBaik());
                isi[i][4] = String.valueOf(b.getKondisiBuruk());
                isi[i][5] = String.valueOf(g.getID());
                i++;
            }
        }
        DefaultTableModel tableModel = new DefaultTableModel(isi,judul);
